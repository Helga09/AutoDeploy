    ...
    public function loadServices()
    {
        ...
        $gitBasedApplications = [
            [
                ...
                'description' => 'Ви можете розгортати будь-які публічні репозиторії від підтримуваних постачальників git.',
                'logo' => asset('svgs/git.svg'),
            ],
            [
                'id' => 'private-gh-app',
                'name' => 'Private Repository (with GitHub App)',
                'description' => 'Ви можете розгортати публічні та приватні репозиторії через свої програми GitHub.',
        ...
        $dockerBasedApplications = [
            [
                'id' => 'dockerfile',
                'name' => 'Dockerfile',
                'description' => 'Ви можете розгорнути простий Dockerfile без Git.',
                'logo' => asset('svgs/docker.svg'),
            ],
            [
                'id' => 'docker-image',
                'name' => 'Docker Image',
                'description' => 'Ви можете розгорнути існуючий образ Docker з будь-якого реєстру без Git.',
                'logo' => asset('svgs/docker.svg'),
            ],
        ];
        $databases = [
            [
                'id' => 'postgresql',
                'name' => 'PostgreSQL',
                'description' => 'PostgreSQL — це реляційна база даних, відома своєю надійністю, розширеними функціями та суворою відповідністю стандартам.',
...
',
            ...
            [
                'id' => 'mongodb',
                'name' => 'MongoDB',
                'description' => 'MongoDB — це кросплатформна програма для роботи з базами даних, доступна з вихідним кодом, орієнтована на документи.',
