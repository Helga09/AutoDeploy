...
<div class="flex flex-col items-center justify-center h-full">
    <div>
        ...
        <h1 class="mt-4 font-bold tracking-tight dark:text-white">Ми працюємо над серйозними речами.</h1>
        <p class="text-base leading-7 dark:text-neutral-400 text-black">Сервіс недоступний. Скоро повернемося. Дякуємо за
            ваше терпіння.
        </p>
