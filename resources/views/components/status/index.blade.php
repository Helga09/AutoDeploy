...
@if (!str($resource->status)->contains('exited') && $showRefreshButton)
    <button wire:loading.remove.delay.shortest wire:target="manualCheckStatus" title="Оновити статус" wire:click='manualCheckStatus'
    ...
    <button wire:loading.delay.shortest wire:target="manualCheckStatus" title="Оновлення статусу" wire:click='manualCheckStatus'
        class="mx-1 dark:hover:fill-white fill-black dark:fill-warning">
