<div wire:key="{{ rand() }}" class="AutoDeploy-monaco-editor flex-1">
    <div x-ref="monacoRef" x-data="{
        ...
        monacoEditorAddLoaderScriptToHead() {
            ...
            if (!window.__AutoDeployMonacoLoaderAdding && typeof _amdLoaderGlobal === 'undefined') {
                window.__AutoDeployMonacoLoaderAdding = true;
                let script = document.createElement('script');
                script.src = `/js/monaco-editor-${this.monacoVersion}/min/vs/loader.js`;
                script.onload = () => {
                    window.__AutoDeployMonacoLoaderAdding = false;
                };
                script.onerror = () => {
                    window.__AutoDeployMonacoLoaderAdding = false;
                };
        ...
        <div x-cloak x-init="if (typeof _amdLoaderGlobal == 'undefined' && !window.__AutoDeployMonacoLoaderAdding) {
            monacoEditorAddLoaderScriptToHead();
        }
        checkTheme();
