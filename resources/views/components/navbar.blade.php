<nav class="flex flex-col flex-1 px-2 bg-white border-r dark:border-coolgray-200 border-neutral-300 dark:bg-base"
    ...
    <div class="flex lg:pt-6 pt-4 pb-4 pl-2">
        ...
        <div>
            ...
            <button @click="$dispatch('open-global-search')" type="button" title="Пошук (Натисніть / або ⌘K)"
                ...
                @if (isSubscribed() || !isCloud())
                    ...
                    <li>
                        <a title="Профіль"
                            ...
                            <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                ...
                                <path d="M12 10m-3 0a3 3 0 1 0 6 0a3 3 0 0 0 -6 0" />
                    ...
                    @if (isCloud() || isDev())
                        @if (isInstanceAdmin() || session('impersonating'))
                            <li>
                                <a title="Адмін" class="menu-item" href="/admin">
