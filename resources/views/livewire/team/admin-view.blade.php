<div>
    <x-slot:title>
        Адміністратор команди | AutoDeploy
    </x-slot>
    <x-team.navbar />
                ...
                <div class="flex items-center justify-center gap-2 mx-4 text-xs font-bold ">
                    <x-modal-confirmation title="Підтвердити видалення користувача?" buttonTitle="Видалити" isErrorButton
                        submitAction="delete({{ $user->id }})" :actions="[
                            'Вибраний користувач буде назавжди видалений з бази даних AutoDeploy.',
                            'Усі ресурси (додатки, бази даних, сервіси, конфігурації, сервери, приватні ключі, теги тощо), пов\'язані з командою за замовчуванням цього користувача, будуть видалені з бази даних AutoDeploy.',
                        ]"
