    ...
    <div class="flex items-center gap-2">
        ...
        @if (!$healthCheckEnabled)
            <x-modal-confirmation title="Підтвердити увімкнення перевірки стану?" buttonTitle="Увімкнути перевірку стану"
                ...
                warningMessage="Якщо перевірка стану не пройде, ваша програма стане недоступною. Будь ласка, перегляньте посібник <a href='https://coolify.io/docs/knowledge-base/health-checks' target='_blank' class='underline text-white'>Перевірки стану</a>, перш ніж продовжити!"
