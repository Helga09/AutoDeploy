<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Очищення Docker | Coolify
    </x-slot>
                        ...
                        @can('update', $server)
                            <x-modal-confirmation title="Підтвердити очищення Docker?" buttonTitle="Запустити ручне очищення"
                                isHighlightedButton submitAction="manualCleanup" :actions="[
                                    'Назавжди видаляє всі зупинені контейнери, керовані Coolify (оскільки контейнери є непостійними, дані не будуть втрачені)',
                                    'Назавжди видаляє всі невикористовувані образи',
                                    'Очищує кеш збірки',
                                    'Видаляє старі версії допоміжного образу Coolify',
                    ...
                    <div class="w-full sm:w-96">
                        <x-forms.checkbox canGate="update" :canResource="$server"
                            ...
                            <ul class='list-disc pl-4 mt-2'>
                                <li>Видаляє зупинені контейнери, керовані Coolify (оскільки контейнери є непостійними, дані не будуть втрачені).</li>
                                <li>Видаляє невикористовувані образи.</li>
                                <li>Очищує кеш збірки.</li>
                                <li>Видаляє старі версії допоміжного образу Coolify.</li>
